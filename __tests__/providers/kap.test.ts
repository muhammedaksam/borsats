...
describe("KAPProvider", () => {
  ...
  describe("getMemberOid", () => {
    it(
      "should get OID for various symbols",
      resilientTest(async () => {
  ...
  describe("getDisclosures Variations", () => {
    it(
      "should get disclosures for various symbols",
      resilientTest(async () => {
  ...
  describe("getCompanyDetails Branches", () => {
    it(
      "should get details for verschiedenen company types",
      resilientTest(async () => {
  ...
  describe("getCalendar", () => {
    it(
      "should get calendar for various symbols",
      resilientTest(async () => {
