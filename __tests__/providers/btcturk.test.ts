...
describe("BTCTurkProvider", () => {
  ...
  describe("getPairs", () => {
    ...
    it("should filter pairs by quote currency", async () => {
    ...
    it("should return USDT pairs when filtering by USDT", async () => {
  ...
  describe("getTicker", () => {
    it("should fetch current ticker for BTCTRY", async () => {
    ...
    it("should fetch current ticker for ETHTRY", async () => {
  ...
  describe("getHistory", () => {
    it("should fetch historical data for BTCTRY with 1d interval", async () => {
    ...
    it("should fetch historical data for ETHTRY with 1h interval", async () => {
      const endDate = new Date();
